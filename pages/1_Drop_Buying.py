...
start_date = st.sidebar.date_input("시작일", value=datetime.date(2010, 1, 1))
end_date = st.sidebar.date_input("종료일", value=datetime.date.today())

st.sidebar.header("2. 하락폭 기준 (지수 대비)")
col1, col2 = st.sidebar.columns(2)
drop_level_1 = st.sidebar.number_input("1단계 하락 (%)", value=-10.0, step=1.0)
drop_level_2 = st.sidebar.number_input("2단계 하락 (%)", value=-15.0, step=1.0)
drop_level_3 = st.sidebar.number_input("3단계 하락 (%)", value=-20.0, step=1.0)
drop_level_4 = st.sidebar.number_input("4단계 하락 (%)", value=-30.0, step=1.0)
...
upro_ratio_2 = st.sidebar.slider("2단계 (L2~L3)", 0, 100, 70)
upro_ratio_3 = st.sidebar.slider("3단계 (L3~L4)", 0, 100, 90)
