...
상태 판단:
  Bear     : KOSPI200 < MA150
  Bull Mix : KOSPI200 > MA150 & TNX > TNX MA120 (금리 상승 위험)
  Bull Full: KOSPI200 > MA150 & TNX ≤ TNX MA120 (최적 상승장)
...
|------|-----------|----------------|------|
| 🐂 Bull Full | KOSPI200 > MA150 & TNX ≤ MA120 | KODEX200 100% | 최적 상승장 — 안정적 상승 추종 |
| ⚠️ Bull Mix | KOSPI200 > MA150 & TNX > MA120 | 레버리지 50% + KODEX200 50% | 상승장이나 금리 위험 — 레버리지 제한 |
| 🐻 Bear | KOSPI200 < MA150 | 단기채권 100% | 하락장 — 완전 방어 |
...
| 🐻 Bear | KOSPI200 < MA{ma_trend} | 단기채권 **{bear_bond}%** + KODEX200 **{bear_k200}%** |
