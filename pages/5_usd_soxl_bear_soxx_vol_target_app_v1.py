"""USD / SOXL strategy with SOXX bear sleeve.

USD is used as the base trend and volatility signal. Bull regimes allocate to
USD and SOXL, while bear regimes use SOXX as the defensive equity sleeve instead
of holding USD. SOXL is modeled as 1.5x USD-equivalent risk because USD is 2x
and SOXL is 3x.
"""
